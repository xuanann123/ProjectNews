...
@section('content')
    ...
    <form action="{{ route('admin.pages.update', $page->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="catalogue-title-input"
                                value="{{ $page->title }}" placeholder="Nhập tiêu đề">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea rows="10" cols="10" class="form-control" name="content">{{ $page->content }}</textarea>
                            @error('content')
                                <span class="text-danger m-2">{{ $message }}</span>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch form-switch-md me-1" dir="ltr">
                                <input type="checkbox" name="is_active" {{ $page->is_active ? "checked" : "" }} value="1" class="form-check-input">
                ...
                <div class="card">
                 ...
                 <div class="text-end mb-3 float-right gap-2">
                    <a href="{{ route('admin.pages.index') }}" class="btn btn-info">Quay lại</a>
