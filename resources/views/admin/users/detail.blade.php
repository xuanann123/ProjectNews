                        ...
                        <div class="row g-4">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    ...
                                    @else
                                        <img src="{{ url('image/notimage.webp') }} " alt="user-img" class="img-thumbnail rounded-circle">
                            ...
                            <div class="col">
                                <div class="p-2">
                                    ...
                                    <p class="text-white text-opacity-75">{{ $user->work }}</p>
                                    <div class="hstack text-white-50 gap-1">
                                        <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $user->address }}</div>
                                        <div>
                                            <i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $user->work }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="d-flex profile-wrapper">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="{{ route("admin.users.edit", $user->id) }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                                    </div>
                                </div>
                                <!-- Tab panes -->
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">FullName :</th>
                                                                        <td class="text-muted">{{ $user->name }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Mobile :</th>
                                                                        <td class="text-muted">+(84) {{ $user->phone }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">JoiningData:</th>
                                            ...
                                            <div class="col-xxl-9">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p>Hi I'm {{ $user->name }}, It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.</p>
                                                                                ...
                                                                                <div class="accordion-item border-0">
                                                                                    <div class="accordion-header" id="headingFive">
                                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="true">
                                                                                            <div class="d-flex">
                                                                                                <div class="flex-shrink-0">
                                                                                                    <img src="{{asset("/assets/images/users/avatar-7.jpg")}}" alt="" class="avatar-xs rounded-circle">
                                                                                                </div>
                                                                                                <div class="flex-grow-1 ms-3">
                                                                                                    <h6 class="fs-14 mb-1">
                                                                                                        Lewis Arnold
