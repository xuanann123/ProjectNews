                    ...
                    <div class="listjs-table" id="customerList">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-auto d-flex ms-5">
                                ...
                                <h5 class="mt-2">Trạng thái slider</h5>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="email">Hình ảnh</th>
                                            ...
                                            @foreach ($data as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="customer_name"><a
                                                            href="{{ route('admin.slides.edit', $item->id) }}">{{ $item->title }}</a>
                                                    </td>
                                                    <td class="email">
                                                        @php
                                                            $url = Storage::url($item->image);
                                                        @endphp
                                                        <img src="{{ $url }}" width="90px" alt="">
                                                    </td>
                                                    <td class="description p-3 border-1">{!! $item->description !!}</td>
                                                                ...
                                                                @can('slide.delete')
                                                                    <div class="remove">
                                                                        ...
                                                                        <a onclick="return confirm('Bạn có muốn xoá {{ $item->title }} không?')"
                                                                            href="{{ route('admin.slides.destroy', $item->id) }}"
                                                                ...
                                                                @can('slide.delete')
                                                                    <div class="restore">
                                                                        <a onclick="return confirm('Bạn có muốn khôi phục {{ $item->title }} không?')"
                                                                            href="{{ route('admin.slides.restore', $item->id) }}"><button
                                                                ...
                                                                @can('slide.delete')
                                                                    <div class="remove">
                                                                        <a onclick="return confirm('Bạn có muốn xoá vĩnh viễn {{ $item->title }} không?')"
                                                                            href="{{ route('admin.slides.forceDelete', $item->id) }}"><button
                                                                                type="button"
