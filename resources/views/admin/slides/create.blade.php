...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.slides.index') }}">Quản lý slider</a></li>
    ...
    <form action="{{ route('admin.slides.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="product-title-input">Tiêu đề slider</label>
                         ...
                         <div class="mb-3">
                            <label class="form-label" for="product-title-input">Đường dẫn url</label>

                            <input type="text" name="url" class="form-control" id="catalogue-title-input"
                                value="" placeholder="Nhập đường dẫn url">
                        </div>
                        <div class="mb-3">
                            <label>Mô tả slider</label>
                            <textarea id="mce" rows="10" cols="10" class="form-control" name="description"></textarea>
                            @error('description')
                                <span class="text-danger m-2">{{ $message }}</span>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Ảnh của slider</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <h6>Slider có hoạt động không</h6>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Người tạo bài viết</h5>
                    </div>
                    <div class="card-body">
