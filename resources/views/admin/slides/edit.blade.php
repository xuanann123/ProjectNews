                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="catalogue-title-input"
                                value="{{ $slide->title }}" placeholder="Nhập tiêu đề">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="mce" rows="10" cols="10" class="form-control" name="description">{!! $slide->description !!}</textarea>
                            @error('description')
                                <span class="text-danger m-2">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <select class="form-select" id="choices-category-input" name="user_id" data-choices
                            ...
                            @foreach ($listUser as $user)
                                <option value="{{ $user->id }}" {{ $slide->user_id == $user->id ? 'selected' : '' }}>
                                    {{ $user->name }}</option>
                            @endforeach
                        </select>
                        @error('user_id')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-7 -bottom-3">
                                @php
                                    $url = Storage::url($slide->image);
                                @endphp
                                <div class="mb-3">
