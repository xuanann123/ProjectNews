      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <div class="content mb-5">
            <h2 id="we-would-love-to-hear-from-you">Chúng tôi rất hận hạnh nhận tin nhắn từ bạn</h2>
            <p>Nếu bạn đang có yêu cầu hoặc cần sự giúp đỡ hãy nhắn tin cho chúng tôi.</p>
          </div>
          <form method="post" action="{{ route("page.contact") }}">
            ...
            <div class="form-group">
              ...
              <input type="text" name="reason" id="email" class="form-control" placeholder="Advertising">
            </div>
            <div class="form-group">
